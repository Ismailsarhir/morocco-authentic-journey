...
class ArchiveToursSettings {
	...
	public function register_settings(): void {
		...
		\register_setting(
			...
			[
				'type'              => 'string',
				'sanitize_callback' => 'sanitize_text_field',
				'default'           => \__( 'Découvrez nos expériences inoubliables', 'transfertmarrakech' ),
			]
		);
		...
		\add_settings_section(
			...
			\__( 'Paramètres de l\'archive des tours', 'transfertmarrakech' ),
	...
	public function render_section_description(): void {
		echo '<p>' . \esc_html__( 'Configurez l\'image, le titre et le sous-titre affichés sur la page d\'archive des tours.', 'transfertmarrakech' ) . '</p>';
	}
	...
	public function render_image_field(): void {
		...
		<div class="tm-archive-image-upload">
			...
			<?php endif; ?>
			<p class="description">
				<?php \esc_html_e( 'Sélectionnez l\'image de fond pour le hero de l\'archive des tours.', 'transfertmarrakech' ); ?>
			</p>
		</div>
		<?php
	}
	...
	public function render_title_field(): void {
		$value = \get_option( self::OPTION_ARCHIVE_TITLE, \__( 'Tous nos tours', 'transfertmarrakech' ) );
		?>
		<input 
			type="text" 
			...
			class="regular-text"
			placeholder="<?php echo \esc_attr__( 'Tous nos tours', 'transfertmarrakech' ); ?>"
		>
		<p class="description">
	...
	public function render_subtitle_field(): void {
		$value = \get_option( self::OPTION_ARCHIVE_SUBTITLE, \__( 'Découvrez nos expériences inoubliables', 'transfertmarrakech' ) );
		?>
		<input 
			type="text" 
			...
			value="<?php echo \esc_attr( $value ); ?>" 
			class="regular-text"
			placeholder="<?php echo \esc_attr__( 'Découvrez nos expériences inoubliables', 'transfertmarrakech' ); ?>"
		>
		<p class="description">
	...
	public static function get_archive_subtitle(): string {
		return \get_option( self::OPTION_ARCHIVE_SUBTITLE, \__( 'Découvrez nos expériences inoubliables', 'transfertmarrakech' ) );
	}
}
